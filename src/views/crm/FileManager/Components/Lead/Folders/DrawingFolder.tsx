...
const DrawingFolder: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if(selected && (!formData.sub_folder_name_first)) {

      setSubmit(true);
      const postData = new FormData();

      postData.append('folder_name', 'Drawing');
      postData.append('sub_folder_name_first', newFolderName || '');
      postData.append('sub_folder_name_second', '');
    ...
    else if (!formData.sub_folder_name_first) {
      toast.push(
