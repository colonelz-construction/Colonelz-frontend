                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <a className="font-medium cursor-pointer" onClick={() => navigate(
                                `/app/crm/fileManager/leads/folder/firstfolder/secondfolder?lead_id=${leadId}&lead_name=${leadName}&folder_name=Drawing&sub_folder_name_first=${sub_folder_name_first}&sub_folder_name_second=${row.original.sub_folder_name_second}`,
                            )}>
